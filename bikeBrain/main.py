...
async def main():
    async with aiohttp.ClientSession() as session:
        ...
        for i in range(nr_of_bikes):
            bikes.append(bikeBrain.Brain(i + 1, session, start_time, bikes_start_positions[i], 100, [0, 0]))
        ...
        for i in range(nr_of_users):
            ...
            position2["geometry"]["coordinates"][0] = position2["geometry"]["coordinates"][0] + 1
            position2["geometry"]["coordinates"][1] = position2["geometry"]["coordinates"][1] + 1
            position3 = position2.copy()
            position3["geometry"]["coordinates"][0] = position3["geometry"]["coordinates"][0] + 2
            position3["geometry"]["coordinates"][1] = position3["geometry"]["coordinates"][1] + 2
